function intelligentMediaController($scope, $log, $http, umbRequestHelper, mediaResource) {
...
angular.module("umbraco").controller("Umbraco.Dashboard.IntelligentMediaController", intelligentMediaController);