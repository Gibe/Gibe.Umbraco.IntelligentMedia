function intelligentMediaPickerController($scope, umbRequestHelper, $log, $http, $document, entityResource, mediaHelper, localizationService, $location, $timeout, dialogService) {
...
angular.module("umbraco").controller("Umbraco.IntelligentMediaPicker", intelligentMediaPickerController);